...
sheet_names_h <- excel_sheets("C:/Users/edeegan/OneDrive - DOI/FFIqaqc/PSME flags_wStatus 2024-02-12 .xlsx")
historical <- lapply(sheet_names_h, function(x) {          # Read all sheets to list
  as.data.frame(read_excel("C:/Users/edeegan/OneDrive - DOI/FFIqaqc/PSME flags_wStatus 2024-02-12 .xlsx", sheet = x)) } )
