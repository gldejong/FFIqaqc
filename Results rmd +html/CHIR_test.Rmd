...
```{r}
setwd("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/")
mtype="PSME"
...
cover=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/CHIR_PIPO_Cover-Species_Composition(metric)_XPT.csv", na.strings=c("","NA"))
fuel1000=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/CHIR_PIPO_Surface_Fuels-1000Hr_XPT.csv", na.strings=c("","NA"))
duff=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/CHIR_PIPO_Surface_Fuels-Duff_Litter_XPT.csv", na.strings=c("","NA"))
fine=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/CHIR_PIPO_Surface Fuels-Fine_XPT.csv", na.strings=c("","NA"))
saps=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/CHIR_PIPO_Trees-Saplings(Diameter_Class)(metric)_XPT.csv", na.strings=c("","NA"))
seeds=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/CHIR_PIPO_Trees-Seedlings(Height_Class)(metric)_XPT.csv")
tree=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/CHIR_PIPO_Trees-Individuals(metric)_XPT.csv")
pbsev=read.csv("C:/Users/edeegan/OneDrive - DOI/Fire_project/Fire_project/CHIR_data/PIPO/PIPO_Post Burn Severity_XPT.csv")
